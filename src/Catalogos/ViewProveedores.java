...
mp.agregar(Integer.parseInt(txt_id.getText()), txt_nombre.getText(), txt_ciudad.getText(), txt_direccion.getText(), Integer.parseInt(txt_telefono.getText()) , txt_correo.getText());
txt_id.setText(" ");
