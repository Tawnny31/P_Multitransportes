...
public class Pepe extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cbx, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
  ...
  String [] nombres = {"daniel", "alison","tawnny","gael"};
  String [] carros = {"audi", "honda","porshe","ford"};
  cbx.removeAllItems ();
  if(mm.getSelectedItem() == "Item 1"){
       for(int i = 0; i < nombres.length ; i++){
             cbx.addItem(nombres[i]);
        }
  }else if(mm.getSelectedItem() == "Item 3"){
        for(int i = 0; i < carros.length ; i++){
             cbx.addItem(carros[i]);
        }
  }
